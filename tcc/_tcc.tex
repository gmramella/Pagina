...
\usepackage{lmodern}            % pacote para usar fonte Adobe Times
...
\author{Ramella}{Giuseppe Moroni}

\advisor[Prof.~Dr.]{Machado}{Rodrigo}

% palavras-chave (iniciar com letras minúsculas, exceto abreviaturas)
...
\begin{figure}
    ...
    \begin{center}
        \includegraphics[width=8em]{img/fig}
    \end{center}
    \legend{Fonte: Os Autores}
    \label{fig:ex1}
\end{figure}
...
\underline{bla} \textbf{bla} \textit{bla}
